--==========================================================
-- ENEMY TRACKER v27 COMPACT + Y550 MODE
--
-- CHANGES
...
-- ON  = follow target X/Z at exact world Y -550.
local TRACK_FIXED_Y = -550
...
RunService.RenderStepped:Connect(function()
	...
	-- Fixed mode: follow only X/Z at exact world Y -550.
	local trackY
